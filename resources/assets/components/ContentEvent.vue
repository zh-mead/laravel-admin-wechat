<template>
    <div>
        ...
        <menu-events-table class="new-event" v-show="newEvent" :events="eventsWithNew" :all-events="events"
                           ref="menuEventsTable"></menu-events-table>
    </div>
</template>

<script>
    import {uniqueKey} from '../common/utils'
    import MenuEventsTable from './MenuEventsTable'
