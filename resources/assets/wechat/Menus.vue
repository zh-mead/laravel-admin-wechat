...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            menuTitleWidth(){
                if(this.menus.length < 3){
                    return this.menuWidth * this.menus.length
                }else {
                    return 100;
                }
            },
        ...
        methods: {
            ...
            addColumn() {
                if (this.menus.length == MAX_COLUMN) {
                    return
                }
            ...
            addSubMenu(parentIndex) {
                ...
                const subMenus = (menu ? menu.sub_button : [])
                if (!subMenus || subMenus.length == MAX_SUB_COUNT) {
                    return
                }

                return this.realAddMenu(subMenus, true, menu.kid)
            },
            realAddMenu(menus, isSub = false, pid = 0) {
